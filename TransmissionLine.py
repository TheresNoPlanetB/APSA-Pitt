...
#Here we calculate series impedance, shunt admittance, primitive admittance matrix, and keeps track of connected buses • Should have child classes (e.g. conductor class)
